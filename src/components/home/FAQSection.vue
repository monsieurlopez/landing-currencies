...
const faqs = [
  ...
  },
  {
    ...
    answer: [
      "You can access historical exchange rates going back to the year 2000. Our historical data endpoint provides rates for any specific date you need, making it perfect for financial analysis, backtesting, and reporting.",
